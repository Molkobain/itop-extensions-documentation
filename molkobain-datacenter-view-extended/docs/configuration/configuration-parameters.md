...
## Parameters of the extended version
  ...
  * `allowed_profiles_for_graphical_edition` List of profiles allowed to use the graphical edition mode. If empty, all profiles are allowed. Value must be a PHP array of profile names.
...
'molkobain-datacenter-view-extended' => [
    ...
    'allowed_profiles_for_graphical_edition' => array[
